...
import com.symantec.dlpx.flexresponse.Credential;

/**
 * This class contains the data needed to perform a quarantine.  All
 * members are public because this is a simple data class.
 */
public class QuarantineData
{
	public String quarantineFolderPath;
	public Credential quarantineFolderWriteCredential;
	public String scanFilePath;
	public Credential scanFolderWriteCredential;
}
